                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <div class="form-group mb-2">
                                ...
                                <textarea class="form-control" rows="5" id="chief_complaint" name="chief_complaint"></textarea>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group mb-2">
                                <label for="assesment" class="form-label">Assesment:</label>
                                <textarea class="form-control" rows="5" id="assesment" name="assesment"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-6">
                            <div class="form-group mb-2">
                                ...
                                <textarea class="form-control" rows="5" id="treatment_plan" name="treatment_plan"></textarea>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group mb-2">
